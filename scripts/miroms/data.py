...
currentStable = [
		...
		'beryl', 'biloba', 'bixi', 'blue', 'breeze', 'byron', 'camellia', 'cannon', 'cas', 'cetus', 'chagall', 'charoite',
		'chenfeng', 'chopin', 'cmi', 'corot', 'courbet', 'creek', 'cupid', 'curtana_in_rf', 'dada', 'dagu', 'dali',
		...
		'yupei', 'zeus', 'zijin', 'zircon', 'ziyi', 'zizhan', 'zorn'
]
...
fullDevices = [
	...
	'beryllium', 'biloba', 'bixi', 'blue', 'bomb', 'breeze', 'byron', 'cactus', 'camellia', 'cancro', 'cancro_lte_ct',
	'cannon', 'cappu', 'capricorn', 'cas', 'cattail', 'cepheus', 'cereus', 'cetus', 'cezanne', 'chagall', 'charoite',
	'chenfeng', 'chiron', 'chopin', 'citrus', 'clover', 'cmi', 'corot', 'courbet', 'creek', 'crux', 'cupid', 'curtana',
	'curtana_in_rf', 'dada', 'dagu', 'daisy', 'dali', 'dandelion', 'dandelion_c3l2', 'dash', 'daumier', 'davinci', 'degas',
	'dew', 'dijun', 'dior', 'dipper', 'diting', 'dizi', 'duchamp', 'earth', 'elish', 'emerald', 'emerald_r', 'enuma',
	'equuleus', 'erhu', 'evergo', 'evergreen', 'excalibur', 'ferrari', 'fire', 'flame', 'flare', 'fleur', 'flourite',
	'flute', 'fog', 'frost', 'fuxi', 'gale', 'garnet', 'gauguin', 'gemini', 'ginkgo', 'goku', 'gold', 'goya', 'gram',
	'grus', 'gucci', 'guitar', 'haotian', 'haydn', 'helium', 'hennessy', 'hermes', 'houji', 'hydrogen', 'ice', 'ido_xhdpi',
	'ingres', 'iolite', 'ishtar', 'jasmine', 'jason', 'jinghu', 'joyeuse', 'kate', 'kenzo', 'klee', 'klein', 'klimt',
	'konghou', 'koto', 'kunzite', 'lake', 'lancelot', 'land', 'lapis', 'latte', 'laurel_sprout', 'laurus', 'lavender',
	'lcsh92_wet_jb9', 'lcsh92_wet_xm_td', 'leedsa', 'leo', 'libra', 'light', 'lightcm', 'lilac', 'lime', 'lisa', 'lithium',
	'liuqin', 'lmi', 'lotus', 'lte26007', 'luming', 'malachite', 'manet', 'marble', 'markw', 'matisse', 'mayfly', 'meri',
	'merlin', 'mido', 'mione_plus', 'miro', 'mist', 'mocha', 'mojito', 'mona', 'mondrian', 'monet', 'moon', 'moonstone',
	'munch', 'muyu', 'myron', 'nabu', 'natrium', 'nezha', 'nikel', 'nitrogen', 'nuwa', 'obsidian', 'odin', 'olive',
	'olivelite', 'olivewood', 'omega', 'onc', 'onclite', 'onyx', 'opal', 'organ', 'oxygen', 'pandora', 'pearl', 'peridot',
	'perseus', 'phoenix', 'piano', 'picasso', 'picasso_48m', 'pine', 'pipa', 'pisces', 'pissarro', 'pissarro_in',
	'pissarroin', 'platina', 'plato', 'polaris', 'popsicle', 'prada', 'prague', 'psyche', 'pudding', 'pyxis', 'raphael',
	'raphaels', 'redwood', 'rembrandt', 'renoir', 'riva', 'rock', 'rodin', 'rolex', 'rosemary', 'rosemary_p', 'rosy',
	'rothko', 'ruan', 'rubens', 'ruby', 'ruyi', 'sagit', 'sakura', 'santoni', 'sapphire', 'sapphiren', 'scorpio', 'sea',
	'selene', 'serenity', 'sheng', 'shennong', 'shennong_t', 'shiva', 'sirius', 'sky', 'socrates', 'somalia', 'songyuan',
	'spark', 'spes', 'spesn', 'spinel', 'spring', 'star', 'steppe', 'sunstone', 'surya', 'sweet', 'sweet_k6a', 'taiko',
	'tanzanite', 'taoyao', 'tapas', 'taurus', 'thor', 'thyme', 'tiare', 'tiffany', 'tissot', 'toco', 'topaz', 'tornado',
	'tucana', 'tulip', 'turner', 'ugg', 'ugglite', 'uke', 'umi', 'unicorn', 'ursa', 'vangogh', 'vayu', 'vela', 'venus',
	'vermeer', 'veux', 'vida', 'vili', 'vince', 'violet', 'violin', 'virgo', 'virgo_lte_ct', 'viva', 'warhol', 'warm',
	'warsaw', 'water', 'wayne', 'whyred', 'willow', 'wt86047', 'wt86047_pro', 'wt88047', 'wt88047_pro', 'wt93007',
	'wt93807', 'wt96007', 'wt98007', 'xaga', 'xuanyuan', 'xun', 'yili', 'ysl', 'yudi', 'yuechu', 'yunluo', 'yupei', 'zeus',
	'zijin', 'zircon', 'ziyi', 'zizhan', 'zorn'
]
