...
fullDevices = [
	...
	'goya', 'gram', 'grus', 'gucci', 'guitar', 'haotian', 'haydn', 'helium', 'hennessy', 'hermes', 'hongkong', 'houji',
	'hydrogen', 'ice', 'ido_xhdpi', 'ingres', 'iolite', 'ishtar', 'jasmine', 'jason', 'jinghu', 'joyeuse', 'kate', 'kenzo',
	'klee', 'klein', 'klimt', 'konghou', 'koto', 'kunzite', 'lake', 'lancelot', 'land', 'lapis', 'latte', 'laurel_sprout',
	'laurus', 'lavender', 'lcsh92_wet_jb9', 'lcsh92_wet_xm_td', 'leedsa', 'leo', 'lhasa', 'libra', 'light', 'lightcm',
	'lilac', 'lime', 'lisa', 'lithium', 'liuqin', 'lmi', 'lotus', 'lte26007', 'luming', 'madrid', 'malachite', 'manet',
	'marble', 'markw', 'matisse', 'mayfly', 'meri', 'merlin', 'mido', 'mione_plus', 'miro', 'mist', 'mocha', 'mojito',
	'mona', 'mondrian', 'monet', 'moon', 'moonstone', 'munch', 'muyu', 'myron', 'nabu', 'natrium', 'nezha', 'nikel',
	'nitrogen', 'nuwa', 'obsidian', 'odin', 'olive', 'olivelite', 'olivewood', 'omega', 'onc', 'onclite', 'onyx', 'opal',
	'organ', 'oxygen', 'pandora', 'pearl', 'peridot', 'perseus', 'phoenix', 'piano', 'picasso', 'picasso_48m', 'pine',
	'pipa', 'pisces', 'pissarro', 'pissarro_in', 'pissarroin', 'platina', 'plato', 'polaris', 'popsicle', 'prada',
	'prague', 'psyche', 'pudding', 'pyxis', 'raphael', 'raphaels', 'redwood', 'rembrandt', 'renoir', 'riva', 'rock',
	'rodin', 'rolex', 'rosemary', 'rosemary_p', 'rosy', 'rothko', 'ruan', 'rubens', 'ruby', 'ruyi', 'sagit', 'sakura',
	'santoni', 'sapphire', 'sapphiren', 'scorpio', 'sea', 'selene', 'serenity', 'sheng', 'shennong', 'shennong_t', 'shiva',
	'shuntian', 'sirius', 'sky', 'socrates', 'somalia', 'songyuan', 'spark', 'spes', 'spesn', 'spinel', 'spring', 'star',
	'steppe', 'sunstone', 'surya', 'sweet', 'sweet_k6a', 'taiko', 'tanzanite', 'taoyao', 'tapas', 'taurus', 'thor',
	'thyme', 'tiare', 'tiffany', 'tissot', 'toco', 'topaz', 'tornado', 'tucana', 'tulip', 'turner', 'ugg', 'ugglite',
	'uke', 'umi', 'unicorn', 'ursa', 'vangogh', 'vayu', 'vela', 'venus', 'vermeer', 'veux', 'vida', 'vili', 'vince',
	'violet', 'violin', 'virgo', 'virgo_lte_ct', 'viva', 'warhol', 'warm', 'warsaw', 'water', 'wayne', 'whyred', 'willow',
	'wt86047', 'wt86047_pro', 'wt88047', 'wt88047_pro', 'wt93007', 'wt93807', 'wt96007', 'wt98007', 'xaga', 'xuanyuan',
	'xun', 'yili', 'yingtian', 'ysl', 'yudi', 'yuechu', 'yunluo', 'yupei', 'zephyr', 'zeus', 'zijin', 'zircon', 'ziyi',
	'zizhan', 'zorn'
]
