...
currentStable = [
		...
		'leedsa', 'lhasa', 'light', 'lightcm', 'lilac', 'lisa', 'liuqin', 'luming', 'malachite', 'manet', 'marble', 'matisse',
		'mayfly', 'miro', 'mist', 'mojito', 'mona', 'mondrian', 'moon', 'moonstone', 'munch', 'muyu', 'myron', 'nabu', 'nezha',
		'nuwa', 'obsidian', 'odin', 'onyx', 'opal', 'organ', 'pandora', 'pearl', 'peridot', 'piano', 'pipa', 'pissarro',
		'pissarro_in', 'pissarroin', 'plato', 'popsicle', 'prague', 'psyche', 'pudding', 'redwood', 'rembrandt', 'renoir',
		'rock', 'rodin', 'rosemary', 'rosemary_p', 'rothko', 'ruan', 'rubens', 'ruby', 'ruyi', 'sapphire', 'sapphiren', 'sea',
		'selene', 'serenity', 'sheng', 'shennong', 'shennong_t', 'sky', 'socrates', 'somalia', 'songyuan', 'spark', 'spes',
		'spesn', 'spinel', 'spring', 'star', 'steppe', 'sunstone', 'sweet', 'sweet_k6a', 'taiko', 'tanzanite', 'taoyao',
		'tapas', 'thor', 'thyme', 'topaz', 'tornado', 'turner', 'uke', 'umi', 'unicorn', 'venus', 'vermeer', 'veux', 'vida',
		'vili', 'violin', 'viva', 'warhol', 'warm', 'warsaw', 'water', 'xaga', 'xuanyuan', 'xun', 'yili', 'yingtian', 'yudi',
		'yuechu', 'yunluo', 'yupei', 'zephyr', 'zeus', 'zijin', 'zircon', 'ziyi', 'zizhan', 'zorn'
]
...
fullDevices = [
	...
	'laurus', 'lavender', 'lcsh92_wet_jb9', 'lcsh92_wet_xm_td', 'leedsa', 'leo', 'lhasa', 'libra', 'light', 'lightcm',
	'lilac', 'lime', 'lisa', 'lithium', 'liuqin', 'lmi', 'lotus', 'lte26007', 'luming', 'malachite', 'manet', 'marble',
	'markw', 'matisse', 'mayfly', 'meri', 'merlin', 'mido', 'mione_plus', 'miro', 'mist', 'mocha', 'mojito', 'mona',
	'mondrian', 'monet', 'moon', 'moonstone', 'munch', 'muyu', 'myron', 'nabu', 'natrium', 'nezha', 'nikel', 'nitrogen',
	'nuwa', 'obsidian', 'odin', 'olive', 'olivelite', 'olivewood', 'omega', 'onc', 'onclite', 'onyx', 'opal', 'organ',
	'oxygen', 'pandora', 'pearl', 'peridot', 'perseus', 'phoenix', 'piano', 'picasso', 'picasso_48m', 'pine', 'pipa',
	'pisces', 'pissarro', 'pissarro_in', 'pissarroin', 'platina', 'plato', 'polaris', 'popsicle', 'prada', 'prague',
	'psyche', 'pudding', 'pyxis', 'raphael', 'raphaels', 'redwood', 'rembrandt', 'renoir', 'riva', 'rock', 'rodin',
	'rolex', 'rosemary', 'rosemary_p', 'rosy', 'rothko', 'ruan', 'rubens', 'ruby', 'ruyi', 'sagit', 'sakura', 'santoni',
	'sapphire', 'sapphiren', 'scorpio', 'sea', 'selene', 'serenity', 'sheng', 'shennong', 'shennong_t', 'shiva', 'sirius',
	'sky', 'socrates', 'somalia', 'songyuan', 'spark', 'spes', 'spesn', 'spinel', 'spring', 'star', 'steppe', 'sunstone',
	'surya', 'sweet', 'sweet_k6a', 'taiko', 'tanzanite', 'taoyao', 'tapas', 'taurus', 'thor', 'thyme', 'tiare', 'tiffany',
	'tissot', 'toco', 'topaz', 'tornado', 'tucana', 'tulip', 'turner', 'ugg', 'ugglite', 'uke', 'umi', 'unicorn', 'ursa',
	'vangogh', 'vayu', 'vela', 'venus', 'vermeer', 'veux', 'vida', 'vili', 'vince', 'violet', 'violin', 'virgo',
	'virgo_lte_ct', 'viva', 'warhol', 'warm', 'warsaw', 'water', 'wayne', 'whyred', 'willow', 'wt86047', 'wt86047_pro',
	'wt88047', 'wt88047_pro', 'wt93007', 'wt93807', 'wt96007', 'wt98007', 'xaga', 'xuanyuan', 'xun', 'yili', 'yingtian',
	'ysl', 'yudi', 'yuechu', 'yunluo', 'yupei', 'zephyr', 'zeus', 'zijin', 'zircon', 'ziyi', 'zizhan', 'zorn'
]
