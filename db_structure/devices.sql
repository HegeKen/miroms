...
CREATE TABLE `devices` (
  ...
  `full_brands` varchar(255) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '品牌全称，所有分支不同品牌的总和，JSON 数组，如 ["Xiaomi","Redmi"]',
  `brands` varchar(255) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '品牌简称，当前分支中 xiaomi/redmi/poco 的总和，逗号分隔，如 "Xiaomi, Redmi"',
  `full_names` varchar(255) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '设备全名，所有分支不同名称的总和，JSON 对象，如 {"zh":"小米14","en":"Xiaomi 14"}',
  `names` varchar(255) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '设备简称，当前分支 xiaomi/redmi/poco 的总和，JSON 对象',
  `xiaomi` varchar(255) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '小米品牌下的设备名，JSON 对象，如 {"zh":"小米14","en":"Xiaomi 14"}',
  ...
  `internal` varchar(255) COLLATE utf8mb3_bin DEFAULT NULL COMMENT '设备内部标识',
  `model` varchar(255) COLLATE utf8mb3_bin DEFAULT NULL COMMENT '设备型号',
  PRIMARY KEY (`id`),
