...
CREATE TABLE `roms` (
  ...
  `logs_uk` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin COMMENT '乌克兰文（uk）更新日志，JSON 格式',
  `logs_pl` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin COMMENT '波兰文（pl）更新日志，JSON 格式',
  `logs_de` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin COMMENT '德文（de）更新日志，JSON 格式',
  `logs_fr` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin COMMENT '法文（fr）更新日志，JSON 格式',
  `logs_it` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin COMMENT '意大利文（it）更新日志，JSON 格式',
  ...
  `logs_ar` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin COMMENT '阿拉伯文（ar）更新日志，JSON 格式',
